...
import 'package:musicon/presentation/nowplaying/nowplayingscreen.dart';
            ...
            IconButton(onPressed: () {
              setState(() {
                if(isfavouritecheck == false){
                  // addtofavoritedatabase(widget.data);
                  context.read<FavouriteBloc>().add(favouriteadd(data: widget.data));
                  
                }else{
                  // deletefavouritelistontap(widget.data);
                  context.read<FavouriteBloc>().add(favouritedelete(data: widget.data));
                ...
                return AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(onPressed: () {
                      ...
                      context.read<FavouriteBloc>().add(favouritedelete(data: data));
...
Widget playlistbar(Playlistmodel data,context,Songsmodel songdata){
  return ClipRRect(
              ...
              child: Container(
                ...
                child:  ListTile(
                  onTap: () {
                    BlocProvider.of<NewplaylistBloc>(context).add(NewplaylistAdd(listname: data.playlistname, data: songdata));
                ...
                return AlertDialog(
                  ...
                  actions: [
                    TextButton(onPressed: () {
                      ...
                      context.read<NewplaylistBloc>().add(Newplaylistdelete(listname: listdata.playlistname, data: data));
    ...
    child: Container(
      ...
      child:  ListTile(
        ...
        trailing: Wrap(
          children: [
            IconButton(onPressed: () {
              BlocProvider.of<NewplaylistBloc>(context).add(NewplaylistAdd(listname: listname, data: data));
              // songaddtoplaylistdatabase(listname, data);
