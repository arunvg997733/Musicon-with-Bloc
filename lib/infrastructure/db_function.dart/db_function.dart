...
addtofavoritedatabase(Songsmodel data)async{
...
addplaylisttodatabase(String listname,List<Songsmodel> listarray)async{
...
updateplaylisttodatabase(String listname,List<Songsmodel> listarray,int index)async{
  final playlistDB = await Hive.openBox<Playlistmodel>('playlistDB');
  bool flag =true;
  for(var element in playlistDB.values){
    if(listname == element.playlistname){
